...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        container = CustomPersistenceContainer(name: "SpendingTrackerSwiftUICoreDataLBTA")//NSPersistentContainer(name: "SpendingTrackerSwiftUICoreDataLBTA")
        
//        let url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.MHAH.SpendingTrackerSwiftUICoreDataLBTA.DBS")
        if inMemory {
